//agrupamos las posibles elecciones del usuario con una clase
class Producto {
...
//guardamos en un array de objetos las distintas combinaciones que puede seleccionar el usuario
...
productosGBA.push(new Producto("Anticuerpos", "GBA", suma(costoAnticuerpos, adicionalGba)));
productosGBA.push(new Producto("Antigenos", "GBA", suma(costoAntigenos, adicionalGba)));
